...
Route::prefix('scheduling_enviroment')->group(function(){
    Route::get('/index', [SchedulingEnvironmentController::class, 'index'])->name('scheduling_enviroment.index');
    Route::get('/create', [SchedulingEnvironmentController::class, 'create'])->name('scheduling_enviroment.create');
    Route::get('/edit/{id}', [SchedulingEnvironmentController::class, 'edit'])->name('scheduling_enviroment.edit');
    Route::post('/create', [SchedulingEnvironmentController::class, 'store'])->name('scheduling_enviroment.store');
    Route::put('/edit/{id}', [SchedulingEnvironmentController::class, 'update'])->name('scheduling_enviroment.update');
    Route::get('/destroy/{id}', [SchedulingEnvironmentController::class, 'destroy'])->name('scheduling_enviroment.destroy');

});

Route::prefix('learning_enviroment')->group(function(){
    Route::get('/index', [LearningEnvironmentController::class, 'index'])->name('learning_enviroment.index');
    Route::get('/create', [LearningEnvironmentController::class, 'create'])->name('learning_enviroment.create');
    Route::get('/edit/{id}', [LearningEnvironmentController::class, 'edit'])->name('learning_enviroment.edit');
    Route::post('/create', [LearningEnvironmentController::class, 'store'])->name('learning_enviroment.store');
    Route::put('/edit/{id}', [LearningEnvironmentController::class, 'update'])->name('learning_enviroment.update');
    Route::get('/destroy/{id}', [LearningEnvironmentController::class, 'destroy'])->name('learning_enviroment.destroy');
